  ...
  return (
    <>
      <div className="relative">
        {deleteActive && <Delete setDeleteActive={setDeleteActive} />}
        ...
        <div className="w-full h-23 bg-white dark:bg-dark px-6 py-[21px] flex justify-between items-center">
          ...
          <button
            ...
            className="w-[90px] h-12 bg-red rounded-3xl flex justify-center items-center text-[15px] font-bold tracking-[-0.25px] text-white cursor-pointer"
          >
            Delete
          </button>
